...
function Mobile() {
  ...
  const products = [
    {
      ...
      image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSgyOr-MgXLm__c9iuQkrk_b8rotMHnJDncGg&s",
    },
    {
      id: 2,
      name: "Galaxy S23",
      ...
      category: "Smartphones",
      image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSajsv-lakiaYJk1qPRdcqy-CfQ-mLcj3t9_A&s",
    },
    {
      id: 3,
      name: "OnePlus 12",
      ...
      category: "Smartphones",
      image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTjfffT_POE72aJ9qY9ixlM0_uI_YoVtMuYxw&s",
    },
    {
      id: 4,
      name: "Smartwatch",
      ...
      image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTjRA-fMfl6_GOngCdI2FGPzddCqZ8ld8jILA&s",
    },
    // {
    //   id: 5,
  ...
  const categories = ["Smartphones", "Accessories"];
  const brands = ["Apple", "Samsung", "OnePlus", "Anker"];
  const prices = [
      ...
      <div className="min-h-screen bg-gray-0 py-8 px-4 sm:px-8 lg:px-12 flex gap-8">
        ...
        <main className="flex absolute left-63 right-0 px-6">
          {filteredProducts.length === 0 ? (
            <p className="text-gray-600">No mobile items found.</p>
          ) : (
